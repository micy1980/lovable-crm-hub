      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="border rounded-lg overflow-hidden">
            {/* Header Row */}
            <div className="grid grid-cols-[1fr_120px_200px_120px_120px_120px_140px] bg-background border-b border-border">
              <div 
            ...
            {filteredCompanies.length === 0 ? (
              ...
              filteredCompanies.map((company: any, index: number) => (
                <div
                  key={company.id}
                  className="grid grid-cols-[1fr_120px_200px_120px_120px_120px_140px] border-b border-border hover:bg-muted/20 transition-colors"
                >
