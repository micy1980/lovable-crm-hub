        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="border rounded-lg overflow-hidden">
              {/* Header Row */}
              <div className="grid grid-cols-[1.8fr_1fr_1.8fr_1.2fr_0.8fr] gap-6 px-4 py-3 bg-muted/30 border-b border-border">
                <div 
                ...
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.map((user: any, index: number) => {
                      ...
                      return (
                        <div
                          key={user.id}
                          className={`grid grid-cols-[1.8fr_1fr_1.8fr_1.2fr_0.8fr] gap-6 px-4 py-3 border-b border-border hover:bg-muted/20 transition-colors ${
